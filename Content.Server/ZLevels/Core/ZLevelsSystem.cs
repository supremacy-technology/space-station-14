...
public sealed partial class ZLevelsSystem : SharedZLevelsSystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<StationZLevelsComponent, StationPostInitEvent>(OnStationPostInit);
    }

    private void OnStationPostInit(Entity<StationZLevelsComponent> ent, ref StationPostInitEvent args)
    {
