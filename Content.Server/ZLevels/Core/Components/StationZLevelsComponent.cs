...
namespace Content.Server.ZLevels.Core.Components;
...
/// </summary>
[RegisterComponent]
public sealed partial class StationZLevelsComponent : Component
{
    [DataField]
    ...
    /// <summary>
    /// Ability to setup shared components for all zLevels
    /// </summary>
    [DataField]
